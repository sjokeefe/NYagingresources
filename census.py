...
foodstamp = foodstamp.rename(columns={'B22001_003E': 'Household with Food Stamp, 60+ member'})
...
payload = {'get': 'NAME,S1702_C02_017E,S0101_C01_030E', 'for': for_clause, 'in': in_clause, 'key': key_value}
...
subject = subject.rename(columns={'S1702_C02_017E': '% below pl 65+', 'S0101_C01_030E': 'Total Population 65+'})
...
census = pd.merge(census, subject['Total Population 65+'], left_index=True, right_index=True)
